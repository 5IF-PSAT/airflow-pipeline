...
task1 = BashOperator(
    ...
    bash_command=f'chmod +x /opt/airflow/scripts/daily_weather.sh && /opt/airflow/scripts/daily_weather.sh {HOST} {PORT} {LATITUDE} {LONGITUDE} {start_date} {end_date} {file_name} {CITY}',
    dag=dag,
)
