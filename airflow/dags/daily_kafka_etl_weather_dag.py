...
LONGITUDE = '-79.383184'
TRANSFORM_TOPIC_NAME = 'transform-topic'
LOAD_TOPIC_NAME = 'load-topic'
...
task1 = BashOperator(
    ...
    bash_command=f'curl \"{HOST}:{PORT}/kafka_ingestion_weather/?transform_topic_name={TRANSFORM_TOPIC_NAME}&load_topic_name={LOAD_TOPIC_NAME}&lat={LATITUDE}&lon={LONGITUDE}&start_date={start_date}&end_date={end_date}&daily=yes\"',
    dag=dag,
)
