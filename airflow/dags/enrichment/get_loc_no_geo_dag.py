...
dag = DAG(
    'get_location_no_geo_dag',
    default_args=default_args,
    description='Get location no geo data',
...
save_loc_no_geo = SparkSubmitOperator(
    task_id='save_loc_no_geo',
    application='/opt/bitnami/spark/app/enrichment/save_loc_no_geo.py',
    conn_id='spark_default',
    dag=dag,
    trigger_rule='none_failed',
    jars='/opt/bitnami/spark/jars/postgresql-42.2.23.jar',
...
start >> create_table_task >> clean_location >> save_loc_no_geo >> end