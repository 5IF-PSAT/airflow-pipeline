...
task11 = BashOperator(
    ...
    bash_command=f'chmod +x /opt/airflow/scripts/hourly_weather.sh && /opt/airflow/scripts/hourly_weather.sh {HOST} {PORT} {LATITUDE} {LONGITUDE} {start_date} {end_date} {CITY}',
    dag=dag,
