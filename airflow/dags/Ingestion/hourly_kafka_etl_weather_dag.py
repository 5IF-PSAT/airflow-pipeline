...
dag = DAG(
    dag_id='hourly_kafka_etl_weather_dag',
    default_args=default_args,
    description='Hourly Kafka ETL weather DAG',
...
end_date = '2017-03-31'
transform_topic_name = 'transform-topic-11'
load_topic_name = 'load-topic-11'
task11 = BashOperator(
    task_id='get_weather_data_20171',
    bash_command=f'curl \"{HOST}:{PORT}/kafka_ingestion_weather/?transform_topic_name={transform_topic_name}&load_topic_name={load_topic_name}&lat={LATITUDE}&lon={LONGITUDE}&start_date={start_date}&end_date={end_date}&city={CITY}\"',
    dag=dag,
...
end_date = '2017-06-30'
transform_topic_name = 'transform-topic-12'
load_topic_name = 'load-topic-12'
task12 = BashOperator(
...
end_date = '2017-09-30'
transform_topic_name = 'transform-topic-13'
load_topic_name = 'load-topic-13'
task13 = BashOperator(
...
end_date = '2017-12-31'
transform_topic_name = 'transform-topic-14'
load_topic_name = 'load-topic-14'
task14 = BashOperator(
...
end_date = '2018-03-31'
transform_topic_name = 'transform-topic-21'
load_topic_name = 'load-topic-21'
task21 = BashOperator(
...
end_date = '2018-06-30'
transform_topic_name = 'transform-topic-22'
load_topic_name = 'load-topic-22'
task22 = BashOperator(
...
end_date = '2018-09-30'
transform_topic_name = 'transform-topic-23'
load_topic_name = 'load-topic-23'
task23 = BashOperator(
...
end_date = '2018-12-31'
transform_topic_name = 'transform-topic-24'
load_topic_name = 'load-topic-24'
task24 = BashOperator(
...
end_date = '2019-03-31'
transform_topic_name = 'transform-topic-31'
load_topic_name = 'load-topic-31'
task31 = BashOperator(
...
end_date = '2019-06-30'
transform_topic_name = 'transform-topic-32'
load_topic_name = 'load-topic-32'
task32 = BashOperator(
...
end_date = '2019-09-30'
transform_topic_name = 'transform-topic-33'
load_topic_name = 'load-topic-33'
task33 = BashOperator(
...
end_date = '2019-12-31'
transform_topic_name = 'transform-topic-34'
load_topic_name = 'load-topic-34'
task34 = BashOperator(
...
end_date = '2020-03-31'
transform_topic_name = 'transform-topic-41'
load_topic_name = 'load-topic-41'
task41 = BashOperator(
...
end_date = '2020-06-30'
transform_topic_name = 'transform-topic-42'
load_topic_name = 'load-topic-42'
task42 = BashOperator(
...
end_date = '2020-09-30'
transform_topic_name = 'transform-topic-43'
load_topic_name = 'load-topic-43'
task43 = BashOperator(
...
end_date = '2020-12-31'
transform_topic_name = 'transform-topic-44'
load_topic_name = 'load-topic-44'
task44 = BashOperator(
...
end_date = '2021-03-31'
transform_topic_name = 'transform-topic-51'
load_topic_name = 'load-topic-51'
task51 = BashOperator(
...
end_date = '2021-06-30'
transform_topic_name = 'transform-topic-52'
load_topic_name = 'load-topic-52'
task52 = BashOperator(
...
end_date = '2021-09-30'
transform_topic_name = 'transform-topic-53'
load_topic_name = 'load-topic-53'
task53 = BashOperator(
...
end_date = '2021-12-31'
transform_topic_name = 'transform-topic-54'
load_topic_name = 'load-topic-54'
task54 = BashOperator(
...
end_date = '2022-03-31'
transform_topic_name = 'transform-topic-61'
load_topic_name = 'load-topic-61'
task61 = BashOperator(
...
end_date = '2022-06-30'
transform_topic_name = 'transform-topic-62'
load_topic_name = 'load-topic-62'
task62 = BashOperator(
...
end_date = '2022-09-30'
transform_topic_name = 'transform-topic-63'
load_topic_name = 'load-topic-63'
task63 = BashOperator(
...
end_date = '2022-12-31'
transform_topic_name = 'transform-topic-64'
load_topic_name = 'load-topic-64'
task64 = BashOperator(
